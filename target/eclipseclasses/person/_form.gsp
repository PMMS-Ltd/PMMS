	...
	<div class="form-inline">
		<div class="form-group ${hasErrors(bean: personInstance, field: 'salutation', 'has-error')} col-xs-2">
			<label for="salutation" class="sr-only"> <g:message
				...
				<g:textField class="form-control input-sm" name="salutation"	value="${personInstance?.salutation}" placeholder="Title" />
		</div>
		...
		<div class="form-group ${hasErrors(bean: personInstance, field: 'firstName', 'has-error')}  col-xs-4">
			...
			<g:textField class="form-control input-sm" name="firstName"
		...
		<div class="form-group ${hasErrors(bean: personInstance, field: 'initial', 'has-error')}  col-xs-2">
			...
			<g:textField class="form-control input-sm" name="initial"
		...
		<div class="form-group ${hasErrors(bean: personInstance, field: 'lastName', 'has-error')} required  col-xs-4">
			...
			<g:textField class="form-control input-sm" name="lastName" required="" value="${personInstance?.lastName}" placeholder="Last Name" />
		</div>
	</div><!-- form-inline -->
</div><!-- row -->
<div class="row" style="margin-top:15px;">
	...
	<div id="postcodeLookup" class="form-inline" style="margin-bottom: 15px;">
		 <div class="form-group col-xs-3">
	 		...
	 		<input type="text" class="form-control" id="unitNo" name="address.unitNo" placeholder="Unit No"/>
	 	</div>
	 	<div class="form-group col-xs-4">
	 		<label class="sr-only" for="postCode">Postcode</label>
	 		<input type="text" class="form-control" id="postcode" name="address.postCode" placeholder="PostCode"/>
	 	</div>
	 ...
	 <fieldset>
		<div class="form-group ${hasErrors(bean: personInstance, field: 'address.address1', 'has-error')} required">
			...
			<div class="col-xs-8">
				<g:textField class="form-control input-sm" name="address.address1"
		...
		<div class="form-group ${hasErrors(bean: personInstance, field: 'address.address2', 'has-error')} ">
			...
			<div class="col-xs-8">
				<g:textField class="form-control input-sm" name="address.address2" maxlength="50" value="${personInstance?.address?.address2}" />
			</div>
		</div>

		<div class="form-group ${hasErrors(bean: personInstance, field: 'address.town', 'has-error')} ">
			<label for="address.town" class="control-label col-xs-4"> <g:message
					code="address.town.label" default="Town" />

			</label>
			<div class="col-xs-6">
				<g:textField class="form-control input-sm" name="address.town"
					value="${personInstance?.address?.town}" />
			</div>
		</div>

		<div class="form-group ${hasErrors(bean: personInstance, field: 'address.county', 'has-error')} ">
			<label for="address.county" class="control-label col-xs-4"> <g:message
					code="address.county.label" default="County" />

			</label>
			<div class="col-xs-6">
				<g:textField class="form-control input-sm" name="address.county"
		...
		<div class="form-group ${hasErrors(bean: personInstance, field: 'address.country', 'has-error')} required">
			...
			<div class="col-xs-6">
				<g:textField class="form-control input-sm" name="address.country" required=""
	...
	<div class="col-sm-6 form-horizontal">
		<div class="form-group">
			...
			<div class="col-xs-9">
				<div class="input-group ${hasErrors(bean: personInstance, field: 'email1', 'has-error')} ">
					...
					<g:field class="form-control input-sm" type="email" name="email1" value="${personInstance?.email1}" />					
				</div>
			</div>
			<div class="col-xs-3">
				<g:select class="form-control input-sm ${hasErrors(bean: personInstance, field: 'email1Type', 'has-error')}" name="email1Type"
		...
		<div class="form-group">
			...
			<div class="input-group ${hasErrors(bean: personInstance, field: 'email2', 'has-error')} ">
				<span class="input-group-addon"><i class="fa fa-envelope-o"></i> &nbsp;</span>
				<g:field class="form-control input-sm" type="email" name="email2"
			...
			<div class="col-xs-3">
				<g:select class="form-control input-sm ${hasErrors(bean: personInstance, field: 'email2Type', 'has-error')}" name="email2Type"
					from="${uk.org.pmms.Person$EmailType?.values()}"
					keys="${uk.org.pmms.Person$EmailType.values()*.name()}"
		...
		<div class="form-group required">
			...
			<div class="col-xs-9">
				<div class="input-group ${hasErrors(bean: personInstance, field: 'phone1', 'has-error')}">
					...
					<g:textField class="form-control input-sm" name="phone1" required="" value="${personInstance?.phone1}" />
				</div>
			</div>
			...
			<div class="col-xs-3">
				<g:select class="form-control input-sm ${hasErrors(bean: personInstance, field: 'phone1Type', 'has-error')}" name="phone1Type"
		...
		<div class="form-group">
			...
			<div class="col-xs-9">
				<div class="input-group ${hasErrors(bean: personInstance, field: 'phone2', 'has-error')}">
					<span class="input-group-addon"><i class="fa fa-phone"></i> &nbsp;</span>
					<g:textField class="form-control input-sm" name="phone2" value="${personInstance?.phone2}" />
				</div>
			</div>
			...
			<div class="col-xs-3">
				<g:select class="form-control input-sm ${hasErrors(bean: personInstance, field: 'phone2Type', 'has-error')}" name="phone2Type"
					from="${uk.org.pmms.Person$PhoneType?.values()}"
					keys="${uk.org.pmms.Person$PhoneType.values()*.name()}" required=""
		...
		<div class="form-group">
			...
			<div class="col-xs-9">
				<div class="input-group ${hasErrors(bean: personInstance, field: 'phone3', 'has-error')}">
					<span class="input-group-addon"><i class="fa fa-phone"></i> &nbsp;</span>
					<g:textField class="form-control input-sm" name="phone3" value="${personInstance?.phone3}" />
				</div>
			</div>
			...
			<div class="col-xs-3">
				<g:select class="form-control input-sm ${hasErrors(bean: personInstance, field: 'phone3Type', 'has-error')}" name="phone3Type"
					from="${uk.org.pmms.Person$PhoneType?.values()}"
					keys="${uk.org.pmms.Person$PhoneType.values()*.name()}" required=""
