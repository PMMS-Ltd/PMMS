...
public String getGroovyPageFileName() { "/WEB-INF/plugins/spring-security-core-2.0-RC2/grails-app/views/login/denied.gsp" }
public Object run() {
Writer out = getOut()
...
public static final long LAST_MODIFIED = 1380850666000L
