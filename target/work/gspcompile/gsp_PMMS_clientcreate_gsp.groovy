...
class gsp_PMMS_clientcreate_gsp extends GroovyPage {
...
invokeTag('eachError','g',25,['bean':(clientInstance),'var':("error")],3)
printHtmlPart(18)
})
invokeTag('hasErrors','g',27,['bean':(clientInstance)],2)
printHtmlPart(11)
createTagBody(2, {->
printHtmlPart(19)
...
invokeTag('form','g',35,['url':([resource:clientInstance, action:'save'])],2)
printHtmlPart(22)
})
...
public static final long LAST_MODIFIED = 1398775384752L
