...
class gsp_PMMS_clientedit_gsp extends GroovyPage {
...
invokeTag('eachError','g',27,['bean':(clientInstance),'var':("error")],3)
printHtmlPart(19)
})
invokeTag('hasErrors','g',29,['bean':(clientInstance)],2)
printHtmlPart(12)
createTagBody(2, {->
printHtmlPart(20)
invokeTag('hiddenField','g',31,['name':("version"),'value':(clientInstance?.version)],-1)
printHtmlPart(21)
...
invokeTag('form','g',38,['url':([resource:clientInstance, action:'update']),'method':("PUT")],2)
printHtmlPart(24)
})
...
public static final long LAST_MODIFIED = 1398775381768L
