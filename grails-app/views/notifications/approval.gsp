...
.btn-success a{
	...
	outline-color: #41a85f !important;
}
.btn-danger a{
	background: #8b1b3f !important;
	outline-color: #8b1b3f !important;
}
</style>
    <!--[if gte mso 9]>
    <style>
                        ...
                        <table class="contents">
                          <tr>
                            <td class="padded text-center">
							  ...
							  <h3>A Site Visit Request requires approval</h3>
                              <!--<p>This is just sample content. You can add your content when you create a campaign using this template. Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore.</p><div class="btn"><a href='#' cs-button>Sample button</a></div><p>Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>-->
							  <p>${approver},</p>
							  <p>Please review the information below and then either accept or reject the request using the voting buttons below</p>
                            </td>
                          </tr>
						  <tr>
							<td class="padded">
							<table class="table">
								<tbody>
									<tr>
										<th>Client</th>
										<td>${sv?.client?.name}</td>
									</tr>
									<tr>
										<th>Date</th>
										<td><g:formatDate date="${sv?.visitStartDate }" format="dd/MM/yyyy"/></td>
									</tr>
									<tr>
										<th>Time</th>
										<td><g:formatDate date="${sv?.visitStartDate }" format="HH:mm"/> - <g:formatDate date="${sv?.visitEndDate }" format="HH:mm"/></td>
									</tr>
									<tr>
										<th>Reason</th>
										<td>${sv?.details }</td>
						   ...
						   <tr>
							<td class="padded" style="padding-top: 35px;">
							<table class="table">
								<tbody>
									<tr>
										<td><div class="btn btn-success"><center><a href="${url}/siteVisit/approve/${sv?.id}" class="cs-button">Accept</a></center></div></td>
										<td><div class="btn btn-danger"><center><a href="${url}/siteVisit/reject/${sv?.id}" class="cs-button">Reject</a></center></div></td>
									</tr>
								</tbody>
							</table>
							</td>
