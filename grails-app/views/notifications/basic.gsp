						  ...
						  <tr>
							...
							<table class="table">
								<tbody>
									...
									<tr>
										<th>Reason</th>
										<td>Because I haven't been for a while</td>
									</tr>
								</tbody>
							</table>
							</td>
						   ...
						   <tr>
							...
							<table class="table">
								<tbody>
									<tr>
										<td><div class="btn btn-success"><center><a href='#' cs-button>Accept</a></center></div></td>
										<td><div class="btn btn-danger"><center><a href='#' cs-button>Reject</a></center></div></td>
									</tr>
								</tbody>
							</table>
							</td>
